<div class="container">
        ...
        <header>
            <div class="logo">
                <a href="#" class="logo"><img src="includes/css/logo1.jpg" alt="Logo"></a>
            </div>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <div class="dropdown-section">
                            ...
                            <a href="hangingPlantsProductList.jsp">Hanging Plants</a>
                        </div>
                        <div class="dropdown-section">
                            <h4>By Name</h4>
    ...
    <script type =module src="/includes/js/main.js">
    </script>